...
document.getElementById('cta').addEventListener('click', function () {
    TweenMax.to('#tomato1', 1, { opacity: 1, y:0, delay: 1, ease: Elastic.easeOut.config(1, 0.3) } );
    TweenMax.to('#tomato2', 1, { opacity: 1, y:0, delay: 1.25, ease: Elastic.easeOut.config(1, 0.3) } );
    TweenMax.to('#tomato3', 1, { opacity: 1, y:0, delay: 1.50, ease: Elastic.easeOut.config(1, 0.3) } );
})

...
document.getElementById('cta').addEventListener('click', function () {
    ...
    TweenMax.to("#elec-pulse-left", 0.5, { opacity:0, delay: 18.75})
    TweenMax.to("#elec-pulse-right", 0.5, { opacity:0, delay: 18.75})
    ...
    TweenMax.to("#elec-pulse-left", 0.5, { opacity:0, delay: 19.75})
    TweenMax.to("#elec-pulse-right", 0.5, { opacity:0, delay: 19.75})
